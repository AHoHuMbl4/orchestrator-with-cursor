...
Большие проекты — цепочка: командующий → наблюдатели + генералы фронтов
(умные субагенты движка) → полковники подзадач (cursor-агенты, роль
`front-colonel`) → исполнители (cursor). Полковник ведёт одну подзадачу (3–5
работ, мини-compass ≤ лимита, один уровень вложенности; эскалация после 2
неудачных кругов) и
