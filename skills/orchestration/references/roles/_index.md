...
| Советник командира (генерал/полковник) | meta/opportunity-advisor.md | советник командира (локальный прогон): развилка → запускает облачных разведчиков web-scout, собирает варианты с источниками, рекомендует |
