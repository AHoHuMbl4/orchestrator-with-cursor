...
| Советник генералов | meta/opportunity-advisor.md | облачный скаут вариантов |

---

**Всего: 143 роли** (каскадный выбор: домен → поддомен → роль) (+ фабрика ролей для нестандартных)
